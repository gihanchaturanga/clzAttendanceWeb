                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Student's Details</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <select name="" id="teacher" class="form-control border-dark">
                                                <option value="">- Select Teacher -</option>
                                                <option value="">Teacher One</option>
                                                <option value="">Teacher Two</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                            <select name="" id="class" class="form-control border-dark">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="datas">
                                            <tr>
                                                ...
                                                <td>0775179587</td>
                                                <td>245/1, Thotillagahawatta, Katuwellegama</td>
