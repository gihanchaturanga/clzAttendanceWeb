...
<head>
    ...
    <title>Pyament Types of Class</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Payment Types of Class</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Payment Types of Class</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add details of Pyament Types</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Name of Payment Type<span class="text-danger">*</span></label>
                                    ...
                                    <input id="clz" type="hidden" value="<?php echo $clz; ?>">

                                    <!-- phone mask -->
                                    <div class="form-group">
                                        <label>Payment<span class="text-danger">*</span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                                </div>
                                                <input id="pay" type="number" class="form-control">
                                            </div>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <button id="input" class="btn btn-primary ml-auto mr-3"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp&nbspAdd Payment</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                    <div class="mt-3">
