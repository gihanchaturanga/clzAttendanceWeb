    ...
    <div class="wrapper">
                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add details of the Student</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>School/College<span class="text-danger"></span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="far fa-user"></i></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="input-group">
                                                ...
                                                <input id="emergency" type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <!-- <button id="input" class="btn btn-primary ml-auto mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspAdd Employee</button> -->
                                        <!-- /.input group -->
                                        <!-- </div> -->
                                        <!-- /.form group -->
                            ...
                            <div class="card card-lightblue">
                                <div class="card-header">
                                    <div class="card-title">Add e-ID to the student</div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>e-ID Code<span class="text-danger"></span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="far fa-user"></i></span>
                                                </div>
                                                <input id="eid" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <!-- <div class="col ml-auto"> -->
                                        <button id="input" class="btn btn-primary ml-auto mr-2">Add Student</button>
                                        <!-- </div> -->
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#school").on("keypress", function(event){
                    if(event.keyCode == 13){
                        $("#dob").focus();
                    }
                });
                $("#dob").on("keypress", function(event){
                    if(event.keyCode == 13){
                        $("#emergency").focus();
                    }
                });
                $("#emergency").on("keypress", function(event){
                    if(event.keyCode == 13){
                        $("#address").focus();
                    }
                });
