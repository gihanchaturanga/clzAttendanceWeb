                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Update details of the teacher</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <button id="input" class="btn btn-warning ml-1 mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspUpdate Teacher</button>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
