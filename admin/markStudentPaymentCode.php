                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="card card-success">
                                <div class="card-header">
                                    <h3 class="card-title">Mark payments of Students</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Teacher<span class="text-danger">*</span></label><br>
                                                <div class="">
                                                ...
                                                <div class="">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="username" class="form-control">
                                                            ...
                                                            <option>Biology - 2022 A/L</option>
                                                            <option>Chemistry - 2021 A/L</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="username" class="form-control">
                                                            ...
                                                            <option>Biology | Chemistry | Phisics - 20,000.00</option>
                                                            <option>Biology | Chemistry | Phisics - 20,000.00</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Student's e-ID<span class="text-danger">*</span></label><br>
                                                <div class="">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <button id="input" class="btn btn-success ml-auto mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspMark As Paid</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
