                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Update details of the Employee</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Employee Type<span class="text-danger">*</span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <select id="username" class="form-control">
                                                    ...
                                                    <option>Class Organiser</option>
                                                    <option>Class Manager</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <button id="input" class="btn btn-warning ml-1 mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspUpdate Employee</button>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
