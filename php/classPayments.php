        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add New Payment Mthods</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Add New Payment Mthods</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add details of the Payment Mthods</h3>
                                </div>
                                <div class="card-body">
                                    <!-- <form method="GET"> -->
            ...
            $.ajax({
                ...
                success: function(res){
                    if(res == 1){
                        ...
                        toastr.error('Please fill all of fields');
                    }
                }
            });
        });
