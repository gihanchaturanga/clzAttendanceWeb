                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Mark Attendance of Students</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <button id="input" class="btn btn-primary ml-auto mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspCheck Student</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
