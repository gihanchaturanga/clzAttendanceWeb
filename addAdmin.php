                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add details of the admin</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Name of Admin<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="institute" class="form-control">
                                                ...
                                                <option>Indeepa Institute - Gampaha</option>
                                                <option>Sysygy - Gampaha</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <button id="input" class="btn btn-primary ml-auto mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspAdd Admin</button>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
        ...
        <script>
            ...
            $("#input").click(function(){
                ...
                if(name != "" && mobile != "" && inst != "" && user != "" && pwd != ""){
                    ...
                    toastr.warning('Please fill all of the required filds');
                }
            });
            ...
            function clear(){
                ...
                $("#institute").prop("selectedIndex", 0);
            }
        </script>
