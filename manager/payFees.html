                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Payment Window</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-success">
                                <div class="card-header">
                                    <h3 class="card-title">Payment for <b>Gihan Chathuranga Attanayake</b></h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <!-- IP mask -->
                                    <div class="row mt-4">
                                        <a class="btn btn-secondary ml-auto" href="payments.html"><i class="fas fa-arrow-circle-left"></i>&nbsp&nbspBack</a>
                                        <button id="input" class="btn btn-success ml-1 mr-3">Mark As Paid</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
