                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Students to Classes</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Students to Classes</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <button id="input" class="btn btn-primary ml-auto mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspAdd To Class</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
