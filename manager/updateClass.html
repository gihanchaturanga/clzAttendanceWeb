                        ...
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Update details of the Class</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Name of Class<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label>Select Teacher<span class="text-danger">*</span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="form-group">
                                        <label>Class Day<span class="text-danger">*</span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="form-group">
                                        <label>Profit<span class="text-danger">*</span></label><br>
                                        <div class="">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                    ...
                                    <!-- IP mask -->
                                    <div class="row mt-4">
                                        <button class="btn btn-primary ml-auto"><i class="fas fa-arrow-circle-left"></i>&nbsp&nbspUpdate Fees</button>
                                        <button id="input" class="btn btn-warning ml-1 mr-3"><i class="fas fa-plus-square"></i>&nbsp&nbspUpdate Class</button>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
